...
import { Star, Moon, Mail, Lock, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-4 py-8">
        ...
        >
          <h2 className="text-2xl font-bold text-white text-center mb-2">{t.welcomeBack}</h2>
          <p className="text-muted-foreground text-center mb-6">{t.loginSubtitle}</p>
