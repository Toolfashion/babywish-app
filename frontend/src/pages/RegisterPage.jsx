...
import { Star, Moon, Mail, Lock, User, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-4 py-8">
        ...
        >
          <h2 className="text-2xl font-bold text-white text-center mb-2">{t.createAccount}</h2>
          <p className="text-muted-foreground text-center mb-6">{t.registerSubtitle}</p>
          ...
          <Button
            ...
            onClick={googleLogin}
            variant="outline"
            className="w-full h-12 mb-6 border-white/20 hover:bg-white/10"
          >
