                    ...
                    <div>
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button variant="outline" className="w-full justify-start text-left bg-white/10 border-white/20 text-white hover:bg-white/20">
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-2xl p-6 border border-purple-500/30">
                    ...
                    <ul className="space-y-2 text-sm text-white/70">
                      <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" />{t.genderPrediction || 'Gender prediction'}</li>
                      <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" />{t.suggestedNames || 'Suggested names'}</li>
                      <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" />{t.zodiacPersonality || 'Zodiac & personality'}</li>
                      <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" />{t.luckyElements || 'Lucky elements'}</li>
                      <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" />{t.moneyBackGuarantee || '95% accuracy or money back'}</li>
                    </ul>
                  </div>
